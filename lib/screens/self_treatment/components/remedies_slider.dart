...
class RemediesSliderPage extends StatefulWidget {
  const RemediesSliderPage({super.key});

  @override
  State<RemediesSliderPage> createState() => _RemediesSliderPageState();
}

class _RemediesSliderPageState extends State<RemediesSliderPage> {
  @override
