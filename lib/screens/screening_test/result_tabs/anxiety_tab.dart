...
class AnxietyTab extends StatefulWidget {
  const AnxietyTab({Key? key}) : super(key: key);

  @override
  State<AnxietyTab> createState() => _AnxietyTabState();
}

class _AnxietyTabState extends State<AnxietyTab> {
  ...
  Future<void> getScore() async {
    ...
    if (!scoreSnapshot.exists) {
      ...
      setState(() {
        anxietyScore = scoreSnapshot.get('anxietyScore');
        anxietySeverity = scoreSnapshot.get('anxietySeverity');
  ...
  Widget build(BuildContext context) {
    final List<ChartData> chartData = <ChartData>[
      ChartData('Anxiety', anxietyScore, severityColor()),
    ];
    return Scaffold(
